...
Class representing a Customer of the client.
...
[CustomerCreatedDate](GoApi.Party.Customer.CustomerCreatedDate.md)|Gets date when contact first became a customer
[DateOfBirth](GoApi.Party.Party.DateOfBirth.md)|Gets or sets the date of birth.
[DeliveryTerm](GoApi.Party.Customer.DeliveryTerm.md)|Gets or set the delivery term.
[DepartmentCode](GoApi.Party.Customer.DepartmentCode.md)|Gets or sets the code of the [Department](GoApi.Dimension.Department.md) this customer belongs to.
[DiscountPercent](GoApi.Party.Customer.DiscountPercent.md)|Gets or sets the fixed discount percent for this customer, this value should be between 0 and 100.     Can also be used to add a premium in percent of the sales price (usually markup) by having negative number. Negative numbers can be between -1000 and 0.
[DoNotAddLatePaymentFees](GoApi.Party.Customer.DoNotAddLatePaymentFees.md)|Gets or sets a value indicating whether or not to add late payment fees when sending reminders to this customer.
[DoNotAddLatePaymentInterest](GoApi.Party.Customer.DoNotAddLatePaymentInterest.md)|Gets or sets a value indicating whether or not to add late payment interest when sending reminders to this customer.
...
[HourlyRate](GoApi.Party.Customer.HourlyRate.md)|Gets or sets the hourly rate to use when billing time to the Customer.
...
[InvoiceBrandingThemeCode](GoApi.Party.Customer.InvoiceBrandingThemeCode.md)|Gets or sets the code of the [BrandingTheme](GoApi.Invoices.BrandingTheme.md) used when sending invoices to this customer. If NULL, the clients default branding theme will be used.
[InvoiceDeliveryType](GoApi.Party.Customer.InvoiceDeliveryType.md)|Gets or sets how invoices should be delivered to the customer.
[InvoiceEmailAddress](GoApi.Party.Customer.InvoiceEmailAddress.md)|Gets or sets the invoice email address.
[InvoiceEmailAddressCC](GoApi.Party.Customer.InvoiceEmailAddressCC.md)|Gets or sets the invoice email CC address. Up to 10 e-mail addresses can be set, semicolon separated. Max length of the string is 2000.
...
[IsVatFree](GoApi.Party.Customer.IsVatFree.md)|Gets or sets a value indicating whether this customer is vat free.     Sales against the customer will use the alternative sales account on the product or product group when posting the revenue if this is set to true.
...
[NoticeOfDebtCollectionDeliveryType](GoApi.Party.Customer.NoticeOfDebtCollectionDeliveryType.md)|Gets or sets how notice of debt collection should be delivered to the customer.
[OurReferenceEmployeeCode](GoApi.Party.Customer.OurReferenceEmployeeCode.md)|Gets or sets the code of the [Employee](GoApi.Party.Employee.md) of the sales person handling this customer (Our reference).
[PaymentTerms](GoApi.Party.Customer.PaymentTerms.md)|Gets or sets the payment terms. This is the default number of days after an invoice sent to this customer is due.
[PhoneNumber](GoApi.Party.Party.PhoneNumber.md)|Gets or sets the phone number.
[ReminderDeliveryType](GoApi.Party.Customer.ReminderDeliveryType.md)|Gets or sets the how reminders should be delivered to the customer.
[ReminderEmailAddress](GoApi.Party.Customer.ReminderEmailAddress.md)|Gets or sets the reminder email address. Used if ReminderDeliveryType and/or NoticeOfDebtCollectionDeliveryType uses email.
...
[SendReminders](GoApi.Party.Customer.SendReminders.md)|Gets or sets a value indicating whether to send reminders for this customer or not.
...
[TransferToDebtCollectionAgency](GoApi.Party.Customer.TransferToDebtCollectionAgency.md)|Gets or sets a value indicating whether invoices to this customers should be transferred to a debt collection agency after it's due.
[UseFactoring](GoApi.Party.Customer.UseFactoring.md)|Gets or sets a value indicating whether it's specified that invoices to this customer should use factoring.
[UseInvoiceFee](GoApi.Party.Customer.UseInvoiceFee.md)|Gets or sets whether invoice fee will be used when invoicing the customer. Relevant only if the client use invoice fee.
...
Name | Description
:----|:------------
[Customer()](GoApi.Party.Customer.Customer__.md)|
