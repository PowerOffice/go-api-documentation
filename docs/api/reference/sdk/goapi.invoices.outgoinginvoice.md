...
OutgoingInvoice representing an Outgoing Invoice or Credit Note that is to be delivered from PowerOffice Go to a specific [Customer](GoApi.Party.Customer.md) .         OutgoingInvoices with a total amount less then 0 is classified as Credit Notes, while positive invoices are Invoices.
...
Name | Description
:----|:------------
[OutgoingInvoice()](GoApi.Invoices.OutgoingInvoice.OutgoingInvoice__.md)|Initializes a new instance of the [OutgoingInvoice](GoApi.Invoices.OutgoingInvoice.md) class.
