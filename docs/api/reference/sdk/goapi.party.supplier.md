...
[StandardGeneralLedgerAccountAgricultureDepartment](GoApi.Party.Supplier.StandardGeneralLedgerAccountAgricultureDepartment.md)|Gets the agriculture department for the standard general ledger account
[StandardGeneralLedgerAccountCode](GoApi.Party.Supplier.StandardGeneralLedgerAccountCode.md)|Gets or sets the code of the standard [GeneralLedgerAccount](GoApi.AccountingSettings.GeneralLedgerAccount.md) that should be used when posting incoming invoices from this supplier.
...
[SupplierCreatedDate](GoApi.Party.Supplier.SupplierCreatedDate.md)|Gets date when contact first became a supplier
...
Name | Description
:----|:------------
[Supplier()](GoApi.Party.Supplier.Supplier__.md)|
