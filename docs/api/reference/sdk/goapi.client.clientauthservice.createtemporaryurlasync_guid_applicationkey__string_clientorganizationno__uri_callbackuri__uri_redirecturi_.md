...
public async Task&lt;GoApi.Client.ClientAuthTemporaryUrlDto&gt; CreateTemporaryUrlAsync(Guid applicationKey, string clientOrganizationNo, Uri callbackUri, Uri redirectUri)
=======
...
clientOrganizationNo|string|The organization number (Vat number) of the client that the client integration should be added to.
