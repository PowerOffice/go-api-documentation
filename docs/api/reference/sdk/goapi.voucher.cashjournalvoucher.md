...
Cash Journal Voucher representing a posted voucher that is of type cash journal (Norwegian: Kontantbilag).     This voucher type contains transactions that are generated from a cash register.
...
[Description](GoApi.Voucher.CashJournalVoucher.Description.md)|Gets or sets the description.
...
[Lines](GoApi.Voucher.CashJournalVoucher.Lines.md)|Gets or sets the cash journal lines ( [CashJournalVoucherLine](GoApi.Voucher.CashJournalVoucherLine.md) ).
...
Name | Description
:----|:------------
[CashJournalVoucher()](GoApi.Voucher.CashJournalVoucher.CashJournalVoucher__.md)|
