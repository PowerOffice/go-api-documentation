...
YearEndJournalVoucherLine
================

Year End Journal Voucher Line representing a voucher line that is posted on a [YearEndJournalVoucher](GoApi.Voucher.YearEndJournalVoucher.md) .     These voucher lines will be posted on the date provided on the head.
...
[CurrencyRate](GoApi.Voucher.YearEndJournalVoucherLine.CurrencyRate.md)|Gets or sets the normalized currency rate of the line (factor to multiply amount in voucher currency with to get amount in local currency).
...
Name | Description
:----|:------------
[YearEndJournalVoucherLine()](GoApi.Voucher.YearEndJournalVoucherLine.YearEndJournalVoucherLine__.md)|
