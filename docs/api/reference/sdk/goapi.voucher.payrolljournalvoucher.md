...
Payroll Journal Voucher representing a posted voucher that is of type payroll journal. (Norwegian: Lønnsbilag)     A payroll journal typically contains accounting entries generated from payrolls in a payroll system.
...
[Description](GoApi.Voucher.PayrollJournalVoucher.Description.md)|Gets or sets the description.
...
[Lines](GoApi.Voucher.PayrollJournalVoucher.Lines.md)|Gets or sets the payroll journal lines [PayrollJournalVoucherLine](GoApi.Voucher.PayrollJournalVoucherLine.md) .
...
Name | Description
:----|:------------
[PayrollJournalVoucher()](GoApi.Voucher.PayrollJournalVoucher.PayrollJournalVoucher__.md)|
