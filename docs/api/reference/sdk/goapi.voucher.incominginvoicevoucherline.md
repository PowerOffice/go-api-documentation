...
Incoming Invoice Voucher Line representing a voucher line that is posted on a [IncomingInvoiceVoucher](GoApi.Voucher.IncomingInvoiceVoucher.md) .         All lines will be posted debit and the debit sum of the lines will be posted credit on the supplier's sub ledger account.         Lines that shall be posted credit should be specified with negative amount.
...
[Accrual](GoApi.Voucher.IncomingInvoiceVoucherLine.Accrual.md)|Gets or sets if GoApi.Voucher.IncomingInvoiceVoucherLine.Accrual is used to enable accrual of the invoice. (Norwegian: Periodisering)
...
[CustomMatchingReference](GoApi.Voucher.IncomingInvoiceVoucherLine.CustomMatchingReference.md)|Gets or sets the custom matching reference. Voucher lines with this value can be matched with other entries with same CustomMatchingReference.
...
Name | Description
:----|:------------
[IncomingInvoiceVoucherLine()](GoApi.Voucher.IncomingInvoiceVoucherLine.IncomingInvoiceVoucherLine__.md)|
