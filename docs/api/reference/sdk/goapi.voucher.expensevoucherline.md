...
Expense Voucher Line representing a voucher line that is posted on a [ExpenseVoucher](GoApi.Voucher.ExpenseVoucher.md) .         All lines will be posted debit and the debit sum of the lines will be posted credit on the employee's sub ledger account.         Lines that shall be posted credit should be specified with negative amount.
...
Name | Description
:----|:------------
[ExpenseVoucherLine()](GoApi.Voucher.ExpenseVoucherLine.ExpenseVoucherLine__.md)|
