...
Outgoing Invoice Voucher Line representing a voucher line that is posted on a [OutgoingInvoiceVoucher](GoApi.Voucher.OutgoingInvoiceVoucher.md) .         All lines will be posted credit and the credit sum of the lines will be posted debit on the Customer sub ledger account.         Lines that shall be posted debit should be specified with negative amount.
...
[Accrual](GoApi.Voucher.OutgoingInvoiceVoucherLine.Accrual.md)|Gets or sets if GoApi.Voucher.OutgoingInvoiceVoucherLine.Accrual is used to enable accrual of the invoice. (Norwegian: Periodisering)
...
[Unit](GoApi.Voucher.OutgoingInvoiceVoucherLine.Unit.md)|Gets or sets the product unit.
[UnitCostPrice](GoApi.Voucher.OutgoingInvoiceVoucherLine.UnitCostPrice.md)|Gets or sets the unit cost price of this outgoing invoice line.
...
Name | Description
:----|:------------
[OutgoingInvoiceVoucherLine()](GoApi.Voucher.OutgoingInvoiceVoucherLine.OutgoingInvoiceVoucherLine__.md)|
