...
Client document representing a document.


### Properties
Name | Description
:----|:------------
[Base64EncodedData](GoApi.Documents.ClientDocument.Base64EncodedData.md)|Base64 encoded string of the actual document.
[CreatedByUserId](GoApi.Documents.ClientDocumentListItem.CreatedByUserId.md)|Gets the Created by user id.
[DocumentVersions](GoApi.Documents.ClientDocument.DocumentVersions.md)|List of [DocumentVersionListItem](GoApi.Documents.DocumentVersionListItem.md) , which are other document versions associated with this document entity.
...
Name | Description
:----|:------------
[ClientDocument()](GoApi.Documents.ClientDocument.ClientDocument__.md)|
