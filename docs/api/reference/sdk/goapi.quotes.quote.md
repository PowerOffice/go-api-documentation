...
Quote representing an offer or estimate of a price for a job or a service that the client is offering a Customer.     If the quote is accepted, it's converted into an Outgoing Invoice.
...
[ExpiryDate](GoApi.Quotes.Quote.ExpiryDate.md)|Gets or sets the expiry date of the quote.
...
[QuoteAcceptanceDate](GoApi.Quotes.Quote.QuoteAcceptanceDate.md)|Gets the date the quote was accepted by the customer.
[QuoteAcceptanceStatus](GoApi.Quotes.Quote.QuoteAcceptanceStatus.md)|Gets the status of the quote. This can either be pending, accepted or rejected depending on how the customer reacted to the offer.
[QuoteDate](GoApi.Quotes.Quote.QuoteDate.md)|Gets or sets the date of the quote.
[QuoteNo](GoApi.Quotes.Quote.QuoteNo.md)|Gets the Quote number. This is assigned by PowerOffice Go when saving.
...
Name | Description
:----|:------------
[Quote()](GoApi.Quotes.Quote.Quote__.md)|
