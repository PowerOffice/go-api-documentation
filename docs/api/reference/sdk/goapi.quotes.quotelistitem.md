...
QuoteListItem that is a lightweight representation of a [Quote](GoApi.Quotes.Quote.md) without details.
...
[ExpiryDate](GoApi.Quotes.QuoteListItem.ExpiryDate.md)|Gets or sets the expiry date of the quote.
...
[QuoteAcceptanceDate](GoApi.Quotes.QuoteListItem.QuoteAcceptanceDate.md)|Gets the date the quote was accepted by the customer.
[QuoteAcceptanceStatus](GoApi.Quotes.QuoteListItem.QuoteAcceptanceStatus.md)|Gets the status of the quote. This can either be pending, accepted or rejected depending on how the customer reacted to the offer.
[QuoteDate](GoApi.Quotes.QuoteListItem.QuoteDate.md)|Gets or sets the date of the quote.
[QuoteNo](GoApi.Quotes.QuoteListItem.QuoteNo.md)|Gets the Quote number. This is assigned by PowerOffice Go when saving.
...
Name | Description
:----|:------------
[QuoteListItem()](GoApi.Quotes.QuoteListItem.QuoteListItem__.md)|
