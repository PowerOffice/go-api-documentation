...
RecurringInvoiceListItem representing an [OutgoingInvoiceListItem](GoApi.Invoices.OutgoingInvoiceListItem.md) that is repeated multiple times without details. This is a lightweight version of [RecurringInvoice](GoApi.Invoices.RecurringInvoice.md) .
...
[AutoClearExclusions](GoApi.Invoices.RecurringInvoiceListItem.AutoClearExclusions.md)|Gets or sets a flag indicating whether the ExceptMonth exception will occur only once (example: Invoice every month except july, but following years invoice every month)         Only applicable when GoApi.Invoices.RecurringInvoiceListItem.ExceptMonths is used.
...
[DaysInAdvance](GoApi.Invoices.RecurringInvoiceListItem.DaysInAdvance.md)|Indicates the number of days in advance this voucher should be created.
...
[EndDate](GoApi.Invoices.RecurringInvoiceListItem.EndDate.md)|Determines if and when the recurring setup should be canceled and GoApi.Invoices.RecurringInvoiceListItem.IsActive set to *false* .
[ExceptMonths](GoApi.Invoices.RecurringInvoiceListItem.ExceptMonths.md)|One or several months can be without invoice.         Only applicable when monthly invoice, and only one invoice per month.
...
[IsActive](GoApi.Invoices.RecurringInvoiceListItem.IsActive.md)|Gets or sets a value indicating whether the recurring invoice is instance is active.
...
[NextInvoiceDate](GoApi.Invoices.RecurringInvoiceListItem.NextInvoiceDate.md)|The invoice date for the next invoice.
...
[RepeatTimes](GoApi.Invoices.RecurringInvoiceListItem.RepeatTimes.md)|Determines how many times this recurring setup should repeat before being canceled and GoApi.Invoices.RecurringInvoiceListItem.IsActive set         to *false* . *null* means infinite.
[SendFrequency](GoApi.Invoices.RecurringInvoiceListItem.SendFrequency.md)|How often the associated invoice should be sent.
[SendFrequencyUnit](GoApi.Invoices.RecurringInvoiceListItem.SendFrequencyUnit.md)|Specifies how often a recurring invoice should be sent.
[SendMethod](GoApi.Invoices.RecurringInvoiceListItem.SendMethod.md)|Determines how to send the associated invoice.
...
Name | Description
:----|:------------
[RecurringInvoiceListItem()](GoApi.Invoices.RecurringInvoiceListItem.RecurringInvoiceListItem__.md)|
