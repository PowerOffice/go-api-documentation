...
Year End Journal Voucher representing a posted voucher that is of type year end journal. (Norwegian: Årsavslutningsbilag)     Year end journals are transactions generated from year end systems after the accounting year is completed.     Year end journals can only be posted on the last day of an accounting year, or the day before conversion date to PowerOffice Go.
...
[Description](GoApi.Voucher.YearEndJournalVoucher.Description.md)|Gets or sets the description.
...
[Lines](GoApi.Voucher.YearEndJournalVoucher.Lines.md)|Gets or sets the year end journal lines.
...
Name | Description
:----|:------------
[YearEndJournalVoucher()](GoApi.Voucher.YearEndJournalVoucher.YearEndJournalVoucher__.md)|
