...
Expense Voucher representing a posted voucher that is of type expense. (Norwegian: Utlegg)     All lines will be posted debit and the debit sum of the lines will be posted credit on the [Employee](GoApi.Party.Employee.md) sub ledger account. Lines that shall be posted credit should be specified with negative amount.
...
[CurrencyRate](GoApi.Voucher.ExpenseVoucher.CurrencyRate.md)|Gets or sets the normalized currency rate of the Expense (factor to multiply amount in voucher currency with to get amount in local currency).
[CustomMatchingReference](GoApi.Voucher.ExpenseVoucher.CustomMatchingReference.md)|Gets or sets the custom matching reference. Vouchers with this value can be matched with other entries with same CustomMatchingReference.
...
[Description](GoApi.Voucher.ExpenseVoucher.Description.md)|Gets or sets the description.
...
[DueDate](GoApi.Voucher.ExpenseVoucher.DueDate.md)|Gets or sets the due date. If not provided, the due date of the expense voucher will be set to VoucherDate.
[EmployeeBankAccountCode](GoApi.Voucher.ExpenseVoucher.EmployeeBankAccountCode.md)|Gets or sets the bank account code to the [Employee](GoApi.Party.Employee.md) that this expense should be refunded to.
[EmployeeCode](GoApi.Voucher.ExpenseVoucher.EmployeeCode.md)|Gets or sets the code of [Employee](GoApi.Party.Employee.md) that this expense is from.
...
[Lines](GoApi.Voucher.ExpenseVoucher.Lines.md)|Gets or sets the expense lines ( [ExpenseVoucherLine](GoApi.Voucher.ExpenseVoucherLine.md) ).         All lines will be posted debit and the debit sum of the lines will be posted credit on the employee's sub ledger account.         Lines that shall be posted credit should be specified with negative amount.
...
Name | Description
:----|:------------
[ExpenseVoucher()](GoApi.Voucher.ExpenseVoucher.ExpenseVoucher__.md)|
