...
Enum defining what kind of voucher the voucher is

### Fields
Name |Value | Description
:----|:-----|:-----------
None|0|No voucher type - validation value
IncomingInvoice|1|Incoming invoice sent from a [Supplier](GoApi.Party.Supplier.md) to the client
IncomingCreditNote|2|Incoming credit note sent from a [Supplier](GoApi.Party.Supplier.md) to the client
OutgoingInvoice|4|Outgoing invoice sent from the client to a [Customer](GoApi.Party.Customer.md)
OutgoingCreditNote|5|Outgoing credit note sent from the client to a [Customer](GoApi.Party.Customer.md)
...
Expense|14|Expense are expenses that have been paid by an [Employee](GoApi.Party.Employee.md) on behalf of the organization (Norwegian: Utlegg).
...
TravelExpense|120|Travel Expense from an [Employee](GoApi.Party.Employee.md) .
...
Name | Description
:----|:------------
[VoucherType()](GoApi.Common.VoucherType.VoucherType__.md)|
