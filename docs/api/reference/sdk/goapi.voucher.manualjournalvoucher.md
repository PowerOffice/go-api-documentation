...
Manual Journal Voucher representing a posted voucher that is of type manual journal. (Norwegian: Manuelt bilag)         Manual journal voucher type is a residual type where we don't have any more specific classification.
...
[Description](GoApi.Voucher.ManualJournalVoucher.Description.md)|Gets or sets the description.
...
[Lines](GoApi.Voucher.ManualJournalVoucher.Lines.md)|Gets or sets the manual journal lines [ManualJournalVoucherLine](GoApi.Voucher.ManualJournalVoucherLine.md) .
...
Name | Description
:----|:------------
[ManualJournalVoucher()](GoApi.Voucher.ManualJournalVoucher.ManualJournalVoucher__.md)|
