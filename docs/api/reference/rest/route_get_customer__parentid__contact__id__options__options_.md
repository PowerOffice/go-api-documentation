...
GET Customer/{parentId}/Contact/{id}?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Customer/{parentId}/Contact/{id}?options=<options>
```
...
### Request Signature
```http
GET /Customer/{parentId}/Contact/{id}?options=<options> HTTP/1.1
