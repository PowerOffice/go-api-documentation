...
GET OutgoingInvoice/{id}/
================

Gets the specified [OutgoingInvoice](Type_OutgoingInvoice.md) by its identifier.

### Url
```http
https://api.poweroffice.net/OutgoingInvoice/{id}/
```
...
### Request Signature
```http
GET /OutgoingInvoice/{id}/ HTTP/1.1
