...
Creates or updates the specified [OutgoingInvoice](Type_OutgoingInvoice.md) .

### Url
```http
https://api.poweroffice.net/OutgoingInvoice/
```
...
:----|:------|:------------
[OutgoingInvoice](Type_OutgoingInvoice.md)|No|The outgoing invoice.

### Response Content
Type | Array | Description
:----|:------|:------------
[OutgoingInvoice](Type_OutgoingInvoice.md)|No|OutgoingInvoice.

### Request Signature
```http
POST /OutgoingInvoice/ HTTP/1.1
