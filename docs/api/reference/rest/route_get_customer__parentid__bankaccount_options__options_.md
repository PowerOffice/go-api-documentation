...
GET Customer/{parentId}/BankAccount?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Customer/{parentId}/BankAccount?options=<options>
```
...
### Request Signature
```http
GET /Customer/{parentId}/BankAccount?options=<options> HTTP/1.1
