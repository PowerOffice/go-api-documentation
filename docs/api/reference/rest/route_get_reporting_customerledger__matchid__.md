...
GET Reporting/CustomerLedger/{matchId}/
================
...
### Url
```http
https://api.poweroffice.net/Reporting/CustomerLedger/{matchId}/
```
...
### Request Signature
```http
GET /Reporting/CustomerLedger/{matchId}/?$filter=<ODataFilter> HTTP/1.1
