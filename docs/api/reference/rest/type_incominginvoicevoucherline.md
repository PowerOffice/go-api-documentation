...
IncomingInvoiceVoucherLine (IncomingInvoiceVoucherLine)
================
...
Accrual|[Accrual](Type_Accrual.md)|Gets or sets if GoApi.Voucher.IncomingInvoiceVoucherLine.Accrual is used to enable accrual of the invoice. (Norwegian: Periodisering)
