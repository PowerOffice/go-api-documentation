...
GET Project/{parentId}/Activity?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Project/{parentId}/Activity?options=<options>
```
...
### Request Signature
```http
GET /Project/{parentId}/Activity?options=<options> HTTP/1.1
