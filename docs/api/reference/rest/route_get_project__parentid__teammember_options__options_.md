...
GET Project/{parentId}/TeamMember?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Project/{parentId}/TeamMember?options=<options>
```
...
### Request Signature
```http
GET /Project/{parentId}/TeamMember?options=<options> HTTP/1.1
