...
GET ContactGroup/{contactGroupName}/employees?contactGroupName=&lt;contactGroupName&gt;&options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/ContactGroup/{contactGroupName}/employees?contactGroupName=<contactGroupName>&options=<options>
```
...
options|[Employee](Type_Employee.md)|
...
### Request Signature
```http
GET /ContactGroup/{contactGroupName}/employees?contactGroupName=<contactGroupName>&options=<options> HTTP/1.1
