...
POST Voucher/ManualJournalVoucher/
================

Saves a [ManualJournalVoucher](Type_ManualJournalVoucher.md) and posts it to the general ledger.
...
:----|:------|:------------
[ManualJournalVoucher](Type_ManualJournalVoucher.md)|No|The voucher
...
### Request Signature
```http
POST /Voucher/ManualJournalVoucher/ HTTP/1.1
