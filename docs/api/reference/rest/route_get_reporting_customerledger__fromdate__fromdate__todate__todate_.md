...
GET Reporting/CustomerLedger/?fromDate=&lt;fromDate&gt;&toDate=&lt;toDate&gt;
================
...
### Url
```http
https://api.poweroffice.net/Reporting/CustomerLedger/?fromDate=<fromDate>&toDate=<toDate>
```
...
### Request Signature
```http
GET /Reporting/CustomerLedger/?fromDate=<fromDate>&toDate=<toDate>&$filter=<ODataFilter> HTTP/1.1
