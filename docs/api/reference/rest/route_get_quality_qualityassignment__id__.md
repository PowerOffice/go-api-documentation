...
GET Quality/QualityAssignment/{id}/
================

Get an [AssignmentAgreement](Type_AssignmentAgreement.md) by its Id.

### Url
```http
https://api.poweroffice.net/Quality/QualityAssignment/{id}/
```
...
### Request Signature
```http
GET /Quality/QualityAssignment/{id}/ HTTP/1.1
