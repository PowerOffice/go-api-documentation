...
POST Voucher/CashJournalVoucher/
================

Saves a [CashJournalVoucher](Type_CashJournalVoucher.md) and posts it to the general ledger.
...
:----|:------|:------------
[CashJournalVoucher](Type_CashJournalVoucher.md)|No|The voucher
...
### Request Signature
```http
POST /Voucher/CashJournalVoucher/ HTTP/1.1
