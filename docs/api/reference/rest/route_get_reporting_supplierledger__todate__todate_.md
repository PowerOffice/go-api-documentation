...
GET Reporting/SupplierLedger/?toDate=&lt;toDate&gt;
================
...
### Url
```http
https://api.poweroffice.net/Reporting/SupplierLedger/?toDate=<toDate>
```
...
### Request Signature
```http
GET /Reporting/SupplierLedger/?toDate=<toDate>&$filter=<ODataFilter> HTTP/1.1
