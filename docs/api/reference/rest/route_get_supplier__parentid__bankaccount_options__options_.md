...
GET Supplier/{parentId}/BankAccount?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Supplier/{parentId}/BankAccount?options=<options>
```
...
### Request Signature
```http
GET /Supplier/{parentId}/BankAccount?options=<options> HTTP/1.1
