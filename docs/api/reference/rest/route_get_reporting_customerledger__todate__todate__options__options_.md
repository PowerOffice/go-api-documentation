...
GET Reporting/CustomerLedger/?toDate=&lt;toDate&gt;&options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Reporting/CustomerLedger/?toDate=<toDate>&options=<options>
```
...
### Request Signature
```http
GET /Reporting/CustomerLedger/?toDate=<toDate>&options=<options> HTTP/1.1
