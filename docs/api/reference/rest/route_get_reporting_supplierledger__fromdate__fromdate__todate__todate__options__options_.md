...
GET Reporting/SupplierLedger/?fromDate=&lt;fromDate&gt;&toDate=&lt;toDate&gt;&options=&lt;options&gt;
================

Gets the [SupplierLedgerEntry](Type_SupplierLedgerEntry.md) statement report between two dates. This includes open items and all entries that are already matched.

### Url
```http
https://api.poweroffice.net/Reporting/SupplierLedger/?fromDate=<fromDate>&toDate=<toDate>&options=<options>
```
...
### Request Signature
```http
GET /Reporting/SupplierLedger/?fromDate=<fromDate>&toDate=<toDate>&options=<options> HTTP/1.1
