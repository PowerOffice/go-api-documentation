...
GET Customer/{parentId}/BankAccount/{id}/
================
...
### Url
```http
https://api.poweroffice.net/Customer/{parentId}/BankAccount/{id}/
```
...
### Request Signature
```http
GET /Customer/{parentId}/BankAccount/{id}/?$filter=<ODataFilter> HTTP/1.1
