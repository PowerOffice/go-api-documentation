...
GET Customer/{parentId}/Contact?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Customer/{parentId}/Contact?options=<options>
```
...
### Request Signature
```http
GET /Customer/{parentId}/Contact?options=<options> HTTP/1.1
