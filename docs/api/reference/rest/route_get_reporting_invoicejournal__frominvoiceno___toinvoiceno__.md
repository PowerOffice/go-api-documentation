...
GET Reporting/InvoiceJournal/{fromInvoiceNo}/{toInvoiceNo}/
================
...
### Url
```http
https://api.poweroffice.net/Reporting/InvoiceJournal/{fromInvoiceNo}/{toInvoiceNo}/
```
...
### Request Signature
```http
GET /Reporting/InvoiceJournal/{fromInvoiceNo}/{toInvoiceNo}/?$filter=<ODataFilter> HTTP/1.1
