...
GET Supplier/{parentId}/Contact?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Supplier/{parentId}/Contact?options=<options>
```
...
### Request Signature
```http
GET /Supplier/{parentId}/Contact?options=<options> HTTP/1.1
