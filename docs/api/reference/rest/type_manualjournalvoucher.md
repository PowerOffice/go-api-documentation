...
ManualJournalVoucher (ManualJournalVoucher)
================
...
Lines|[ManualJournalVoucherLine](Type_ManualJournalVoucherLine.md)|Gets or sets the manual journal lines [ManualJournalVoucherLine](Type_ManualJournalVoucherLine.md) .
