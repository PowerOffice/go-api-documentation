...
### Url
```http
https://api.poweroffice.net/Customer/?options=<options>
```
...
:----|:-------|:------------
options|[Customer](Type_Customer.md)|The options.
...
### Request Signature
```http
GET /Customer/?options=<options> HTTP/1.1
