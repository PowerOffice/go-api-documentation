...
GET Quality/QualityAssignment/?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Quality/QualityAssignment/?options=<options>
```
...
:----|:-------|:------------
options|[AssignmentAgreement](Type_AssignmentAgreement.md)|
...
### Request Signature
```http
GET /Quality/QualityAssignment/?options=<options> HTTP/1.1
