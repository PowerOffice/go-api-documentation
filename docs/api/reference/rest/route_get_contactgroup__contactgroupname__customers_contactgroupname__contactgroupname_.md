...
GET ContactGroup/{contactGroupName}/customers?contactGroupName=&lt;contactGroupName&gt;
================
...
### Url
```http
https://api.poweroffice.net/ContactGroup/{contactGroupName}/customers?contactGroupName=<contactGroupName>
```
...
### Request Signature
```http
GET /ContactGroup/{contactGroupName}/customers?contactGroupName=<contactGroupName>&$filter=<ODataFilter> HTTP/1.1
