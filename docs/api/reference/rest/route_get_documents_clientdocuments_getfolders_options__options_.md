...
GET Documents/ClientDocuments/GetFolders?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Documents/ClientDocuments/GetFolders?options=<options>
```
...
:----|:-------|:------------
options|[DocumentFolder](Type_DocumentFolder.md)|
...
### Request Signature
```http
GET /Documents/ClientDocuments/GetFolders?options=<options> HTTP/1.1
