...
GET Reporting/TimeTransactions/?fromDate=&lt;fromDate&gt;&toDate=&lt;toDate&gt;&orderNo=&lt;orderNo&gt;&invoiceNo=&lt;invoiceNo&gt;&payrollNo=&lt;payrollNo&gt;&options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Reporting/TimeTransactions/?fromDate=<fromDate>&toDate=<toDate>&orderNo=<orderNo>&invoiceNo=<invoiceNo>&payrollNo=<payrollNo>&options=<options>
```
...
options|[TimeTransaction](Type_TimeTransaction.md)|The options.
...
### Request Signature
```http
GET /Reporting/TimeTransactions/?fromDate=<fromDate>&toDate=<toDate>&orderNo=<orderNo>&invoiceNo=<invoiceNo>&payrollNo=<payrollNo>&options=<options> HTTP/1.1
