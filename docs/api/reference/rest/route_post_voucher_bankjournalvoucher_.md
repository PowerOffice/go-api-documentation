...
POST Voucher/BankJournalVoucher/
================

Saves a [BankJournalVoucher](Type_BankJournalVoucher.md) and posts it to the general ledger.

### Url
```http
https://api.poweroffice.net/Voucher/BankJournalVoucher/
```
...
:----|:------|:------------
[BankJournalVoucher](Type_BankJournalVoucher.md)|No|The voucher
...
### Request Signature
```http
POST /Voucher/BankJournalVoucher/ HTTP/1.1
