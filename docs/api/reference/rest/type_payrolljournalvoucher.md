...
PayrollJournalVoucher (PayrollJournalVoucher)
================
...
Lines|[PayrollJournalVoucherLine](Type_PayrollJournalVoucherLine.md)|Gets or sets the payroll journal lines [PayrollJournalVoucherLine](Type_PayrollJournalVoucherLine.md) .
