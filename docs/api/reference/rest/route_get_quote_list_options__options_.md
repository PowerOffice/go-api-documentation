...
GET Quote/List?options=&lt;options&gt;
================
...
### Url
```http
https://api.poweroffice.net/Quote/List?options=<options>
```
...
:----|:-------|:------------
options|[QuoteListItem](Type_QuoteListItem.md)|The options.
...
### Request Signature
```http
GET /Quote/List?options=<options> HTTP/1.1
