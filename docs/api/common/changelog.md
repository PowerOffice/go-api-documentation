...
### 3.0.1 (08.05.2026)
- ClientIntegrationInformation: New endpoint listing the active PowerOffice Go modules and priviliges on a given client.
...
- **Removed Customer-object from CustomerLedgerResponse**. Use CustomerCode to identify the Customer, and fetch additional information from the Customer endpoint.
