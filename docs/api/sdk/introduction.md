...
The first thing you must do is to register as an integration parter to obtain an *application key*. Please read the [Registration and Client activation](/Common/Registration.md) section.
...
## Design Principles
Read about the design principles in the PowerOffice C# SDK [here](Concepts.md)
